...
Edge::Edge(Node& rSrc, Node& rDst, double weight) : m_rSrc(rSrc), m_rDst(rDst), m_weight(weight)
{
...
Edge::Edge(const Edge& rOther) : m_rSrc(rOther.m_rSrc), m_rDst(rOther.m_rDst), m_weight(rOther.m_weight)
{	
